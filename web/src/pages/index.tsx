import { Ref, useCallback, useEffect, type ReactNode } from "react";
  ...
  return (
    <header className={clsx("hero hero--primary", styles.heroBanner)}>
      <div className={styles.container}>
        {ref && (
          <video style={{ filter: "hue-rotate(var(--hue-rot))" }} ref={ref as Ref<HTMLVideoElement>} autoPlay muted loop playsInline>
