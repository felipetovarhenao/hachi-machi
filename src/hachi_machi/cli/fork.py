...
def fork(**params):
    """
    Given some **INPUT** data, it generates an **OUTPUT** data file (`.txt`, `.csv`, `.json`, `.llll`), given any number of optional data augmentation [operations](/docs/commands/operations).
